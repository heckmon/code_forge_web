...
sealed class LspConfig {
  ...
  /// Helper method to convert file paths to proper URIs for web compatibility.
  ...
  Future<void> initialize() async {
    // Handle both regular paths and file:// URIs for web compatibility
    final workspaceUri = workspacePath.startsWith('file://')
        ? workspacePath
  ...
  ///
  /// This method is used internally by the [CodeForgeWeb], calling this with appropriate parameters will returns a [List] of [LspCompletion].
  ...
  ///
  /// This method is used internally by the [CodeForgeWeb], calling this with appropriate parameters will returns a [String].
...
/// This class is used internally by the [CodeForgeWeb] widget to display completion suggestions.
class LspCompletion {
...
/// This class is used internally by the [CodeForgeWeb] widget to display errors in the editor.
class LspErrors {
