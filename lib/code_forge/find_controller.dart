...
/// Controller for managing text search functionality in [CodeForgeWeb].
///
...
class FindController extends ChangeNotifier {
  final CodeForgeWebController _codeController;
  ...
  /// Creates a [FindController] associated with the given [CodeForgeWebController].
